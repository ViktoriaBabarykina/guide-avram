(function () {
  ...
  const I18N = {
    ru: {
      ...
      cardNote: 'Билеты оплачиваются отдельно',
    ...
    en: {
      ...
      cardNote: 'Tickets paid separately',
  ...
  window.TOURS = [
    ...
    { id: 'samarkand', cat: 'day', badgeClass: 'star', img: IMG + 'sam/sam1.webp',
      ...
      ru: { title: 'Самарканд: всё самое главное за один день + дегустация плова', meta: '6 часов · Самарканд · гид + транспорт', price: 'от $140', unit: 'за экскурсию · 1–4 чел', badge: 'С дегустацией',
        ...
        incl: ['Услуги гида и транспорт', 'Главные памятники Самарканда', 'Шёлково-ковровая фабрика', 'Дегустация самаркандского плова (оплачивается отдельно)'] },
      en: { title: 'Samarkand: all the highlights in one day + plov tasting', meta: '6 hours · Samarkand · guide + transport', price: 'from $140', unit: 'per tour · 1–4 people', badge: 'With tasting',
        ...
        incl: ['Guide services and transport', "Samarkand's main monuments", 'Silk-carpet workshop', 'Samarkand plov tasting (paid separately)'] } },
    ...
    { id: 'transfer', cat: 'day', badgeClass: '', noNote: true, img: IMG + 'transfer/3bf1506f-9d0a-4a8f-84d0-5b83602ef17b.webp',
  ...
  window.GALLERY = [
    ...
    { src: IMG + 'tourists/IMG_2694.webp', w: 'w-s' },
    { src: IMG + 'tourists/IMG_7298.webp', w: 'w-m' },
    { src: IMG + 'tourists/IMG_8993.webp', w: 'w-l' },
    // тёплые золотисто-земляные тона, от светлого к тёмному
    { src: IMG + 'tourists/0daa5087-2649-4ecf-9b59-3444a34cb753.webp', w: 'w-s' },
    { src: IMG + 'tourists/IMG_3215.webp', w: 'w-m' },
    ...
    { src: IMG + 'tourists/IMG_3204.webp', w: 'w-s' },
